...
function onLoad() {
    ...
    ws.onmessage = function(e) {
        ...
        if (e.data[0] == '6') //刷新拉流，角色等等（相当于刷新界面，注意数组是否需要清空等等）
        {
            ...
            document.getElementById("my_close").innerHTML = "结束会议";
    ...
    for (var i = 0; i < my_user_number.length; i++) {
        if (my_user_number[i][0] == user_name) {
            if (my_user_number[i][1] == '1') {
                document.getElementById("u4_img").src = "img/regen/u18.png";
            } else {
...
function do_close() {
    ...
    } else if (document.getElementById("my_close").innerHTML == "结束会议") {
        ws.send(user_room + ',s');
    }
}
...
function show_right_juese(my_user_number) {
    ...
    if (my_user_number.length >= 1) {
        ...
        if (my_user_number[0][3] == '1') {
            document.getElementById("u99_img").src = "img/regen/u8.png";
        } else {
            document.getElementById("u99_img").src = "img/regen/u22.png";
        }
        if (my_user_number[0][4] == '1') {
            document.getElementById("u97_img").src = "img/regen/u10.png";
        } else {
            document.getElementById("u97_img").src = "img/regen/u24.png";
        }
        ...
        if (my_user_number.length >= 2) {
            ...
            if (my_user_number[1][3] == '1') {
                document.getElementById("u90_img").src = "img/regen/u8.png";
            } else {
                document.getElementById("u90_img").src = "img/regen/u22.png";
            }
            if (my_user_number[1][4] == '1') {
                document.getElementById("u88_img").src = "img/regen/u10.png";
            } else {
                document.getElementById("u88_img").src = "img/regen/u24.png";
            }
            ...
            if (my_user_number.length >= 3) {
                ...
                if (my_user_number[2][3] == '1') {
                    document.getElementById("u81_img").src = "img/regen/u8.png";
                } else {
                    document.getElementById("u81_img").src = "img/regen/u22.png";
                }
                if (my_user_number[2][4] == '1') {
                    document.getElementById("u79_img").src = "img/regen/u10.png";
                } else {
                    document.getElementById("u79_img").src = "img/regen/u24.png";
                }
            }
        }
    }
...
function click_screen2() {
    ...
    window.location.href = "index.html?user=" + user_name + "=" + user_room + '=page1.html';
}
